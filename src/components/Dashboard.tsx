 ...
 * distribusi kelas, grafik prediksi terakhir, dan quick actions.
 */
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          sub="K=3, 5-Fold CV"
        />
        <StatCard icon={BarChart3} label="Fitur Input" value="4" sub="Usia, JK, Pop, Alasan" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-slate-400 mt-1">Masukkan data pasien untuk prediksi</div>
          </div>
